...
namespace TopNews.Infrastructure.Migrations
{
    ...
    [Migration("20230821160338_Add_New_Seed")]
    partial class Add_New_Seed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopNews.Infrastructure.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopNews.Infrastructure.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopNews.Infrastructure.Entities.Post", b =>
                {
                    b.HasOne("TopNews.Infrastructure.Entities.Category", "Category")
                        .WithMany("Post")
