...
namespace TopNews.Infrastructure.Migrations
{
    ...
    [Migration("20230908172157_dashboardAccess")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopNews.Core.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopNews.Core.Entities.DashboardAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopNews.Core.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopNews.Core.Entities.Post", b =>
                {
                    b.HasOne("TopNews.Core.Entities.Category", "Category")
                        .WithMany("Post")
